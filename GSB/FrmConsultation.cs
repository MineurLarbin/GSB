...
namespace GSB
{
    public partial class FrmConsultation : FrmBase
    {
        ...
        private void remplirDgvVisites()
        {
            ...
            {
                dgvVisites.Rows.Add(uneVisite, uneVisite.DateEtHeure.ToShortDateString(),
                    ...
                    //uneVisite.LePraticien.Ville.Substring(0).First().ToString().ToUpper() + uneVisite.LePraticien.Ville.Substring(1).ToString().ToLower() );
            }
            afficher();
        }
        ...
        private void afficher()
        {
            ...
            //alimentaion des medicaments présentés.
